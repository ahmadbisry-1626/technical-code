        ...
        <section className="w-full flex flex-col pt-20 md:pt-24 gap-3 pb-10" id="movieDetails">
            ...
            {isLoading ? (
                ...
                <div className='flex items-center gap-4 w-full md:h-[400px] h-[600px]'>
                    ...
                    <div className='w-full md:max-w-[300px] h-full relative rounded-[12px] overflow-hidden'>
            ...
            <div className='flex flex-col gap-2 w-full'>
                ...
                <div className='flex items-center gap-2'>
                    <h2 className='text-primary text-[16px] md:text-[18px] font-semibold'>Rating:</h2>
